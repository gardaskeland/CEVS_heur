...
const auto cmp = [](pair<int, pair<int, int>> left, pair<int, pair<int, int>> right)
...
class BMerge() {
    public:
        ...
        priority_queue<pair<int, pair<int, int>>, vector<pair<int, pair<int, int>>>, decltype(cmp)> pq_merge_cost; 
