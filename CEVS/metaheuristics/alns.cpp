...
LoggingSolution alns(Graph &g, LoggingSolution &log_sol, int &num_operations) {
    ...
    for (int i = 0; i < num_operations; i++) {
        ...
        if (r < c_weights[0]) {
            ...
            new_cost = current_cost + add_all_nodes_to_neighbours(wg, current_solution);
            ...
            choice = 3;
            new_cost = current_cost + label_propagation_round_cool(wg, current_solution, t);
            ...
            choice = 5;
            new_cost = current_cost + add_node_to_all_cool(wg, current_solution, t);
